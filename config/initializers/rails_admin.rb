...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = [CategoryLocTourism, Comment, Contact, Event, Folktale, LocationTourism, TipsTrick, TourismArticle, User, WhySumbar]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [CategoryLocTourism, Comment, Contact, Event, Folktale, LocationTourism, TipsTrick, TourismArticle, User, WhySumbar]
  ...
  #   # Found associations:
  #     configure :why_sumbars, :has_many_association 
